...
const Gallery = ({ selectedUser, userAccounts, setSelectedUser }) => {
  ...
  return <div>
    <Header pageTitle="Gallery" user={userFromHeader ? userFromHeader : selectedUser} otherUser={userAccounts} sendDataToHeader={handleDataFromHeader} />
