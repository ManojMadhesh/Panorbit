...
const Todo = ({ selectedUser, userAccounts, setSelectedUser }) => {
  ...
  return <div>
    <Header pageTitle="Todo" user={userFromHeader ? userFromHeader : selectedUser} otherUser={userAccounts} sendDataToHeader={handleDataFromHeader} />
